...
namespace SQLBuilder.Oracle.Builder {
    ...
    public class SelectQuery : BaseQuery {
        ...
        /// <param name="ConditionStatement">The condition statment/s of the joined table.</param>
        /// <returns>The current instance of this class.</returns>
        public SelectQuery SetInnerJoin(string Schema, string Table, string TableAlias, string ConditionStatement) {
            if (Schema.IsNullOrWhiteSpace()) {
                throw new ArgumentException("Schema argument should not be empty.");
            }
            if (Table.IsNullOrWhiteSpace()) {
            ...
            this._Joins.Add(String.Format("INNER JOIN {0}.{1}{2} ON ({3})", Schema, Table, !Table.Equals(TableAlias) ? String.Format(" {0}", TableAlias) : null, ConditionStatement));
            return this;
        }
        ...
        /// <param name="ConditionStatement">The condition statment/s of the joined table.</param>
        /// <returns>The current instance of this class.</returns>
        public SelectQuery SetInnerJoin(string Schema, string Table, uint IncrementTableAlias, string ConditionStatement) {
            if (IncrementTableAlias == 0) {
                return this.SetInnerJoin(Schema, Table, Table, ConditionStatement);
            }
            return this.SetInnerJoin(Schema, Table, Table + "_" + IncrementTableAlias, ConditionStatement);
        }
        ...
        public SelectQuery SetInnerJoin(string Table, string TableAlias, string ConditionStatement) {
            ...
            this._Joins.Add(String.Format("INNER JOIN {0}.{1}{2} ON ({3})", this._Schema, Table, !Table.Equals(TableAlias) ? String.Format(" {0}", TableAlias) : null, ConditionStatement));
            return this;
        }
        ...
        public SelectQuery SetInnerJoin(string TableAlias, string ConditionStatement) {
            ...
            this._Joins.Add(String.Format("INNER JOIN {0}.{1} {2} ON ({3})", this._Schema, this._Table, !this._Table.Equals(TableAlias) ? String.Format(" {0}", TableAlias) : null, ConditionStatement));
            return this;
        }
        ...
        public SelectQuery SetInnerJoin(SelectQuery Select, string TableAlias, string ConditionStatement) {
            ...
            this._Joins.Add(String.Format("INNER JOIN ({0}) {1} ON ({2})", strQuery, TableAlias, ConditionStatement));
            return this;
        }
        ...
        public SelectQuery SetInnerJoin(List<SelectQuery> Selects, string TableAlias, string ConditionStatement) {
            ...
            this._Joins.Add(String.Format("INNER JOIN ({0}) {1} ON ({2})", String.Format("({0})", String.Join(") UNION (", lstQueries.ToArray())), TableAlias, ConditionStatement));
            return this;
        }
